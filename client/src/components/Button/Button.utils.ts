...
const PrimaryButtonVariantClasses = {
  ...
  error:
    'border-4 btn-primary border-chalk-pink bg-chalk-pink text-board-green hover:bg-dark-chalk-pink hover:border-dark-chalk-pink',
  warning:
...
const SecondaryButtonVariantClasses = {
  ...
  error:
    'border-t-2 border-l-2 border-r-8 border-b-8 bg-transparent border-chalk-pink text-chalk-pink hover:text-board-green focus:text-board-green hover:bg-chalk-pink focus:bg-chalk-pink',
  warning:
